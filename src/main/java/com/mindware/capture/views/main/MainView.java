package com.mindware.capture.views.main;
...
import com.mindware.capture.views.reportes.ReportesView;
 ...
 */
@PWA(name = "CAPTURE", shortName = "CAPTURE", enableInstallPrompt = false)
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "CAPTURE logo"));
        logoLayout.add(new H1("CAPTURE"));
